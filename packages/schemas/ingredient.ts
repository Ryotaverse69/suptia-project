...
export const ingredient = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      of: [{ type: "string" }],
      description:
        "この成分が貢献する健康目標のタグ。診断機能で使用されます。（診断エンジンのHealthGoal型と一致）",
      options: {
        list: [
          { title: "免疫力強化", value: "immune-boost" },
          { title: "肌の健康", value: "skin-health" },
          { title: "疲労回復・エネルギー", value: "energy-recovery" },
          { title: "筋力向上", value: "muscle-growth" },
          { title: "骨の健康", value: "bone-health" },
          { title: "心血管の健康", value: "heart-health" },
          { title: "脳機能・認知機能", value: "brain-function" },
          { title: "睡眠の質", value: "sleep-quality" },
          { title: "ストレス軽減", value: "stress-relief" },
          { title: "消化器の健康", value: "digestive-health" },
          { title: "目の健康", value: "eye-health" },
          { title: "アンチエイジング", value: "anti-aging" },
          { title: "体重管理", value: "weight-management" },
          { title: "関節の健康", value: "joint-health" },
          { title: "総合的な健康維持", value: "general-wellness" },
        ],
      },
      group: "safety",
    }),
