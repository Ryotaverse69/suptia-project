...
- **栄養価スコアの計算式**
  ...
  ```typescript
  nutritionScore = Σ(成分mg / RDA) × エビデンススコア
  ```
...
#### フェーズ2.7-B: ターゲット別最適化（2026年2月〜3月）

- **パーソナライズド推奨量**
  - 年齢・性別別の推奨量を参照
  - 目的別（筋肉増強、美容、免疫強化）の最適化
  - ライフステージ別（妊娠中、授乳中、高齢者）対応

- **実装内容**
  - ユーザープロファイル機能（Supabase連携）
  - 動的な推奨量計算
  - パーソナライズドランク表示

#### フェーズ2.7-C: 高度な分析UI（2026年3月〜4月）

- **成分別コストグラフ**
  - 主要成分5つの個別コストを可視化
  - 他商品との比較グラフ
  - Chart.jsまたはRechartを使用
