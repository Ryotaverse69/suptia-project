...
| 項目       | 目標                           |
| ---------- | ------------------------------ |
| 再申請時期 | 2026年3月（サイト開始6ヶ月後） |
| 月間PV     | 10,000以上                     |
| Amazon売上 | 3件以上達成                    |
| コンテンツ | 成分ガイド50件以上             |

**注意**: iHerb直接アフィリエイトにはAPIがないため、価格比較機能にはCJ経由が必須

### 米国展開時に追加予定のCJアフィリエイト

| 広告主           | 特徴                | 優先度 |
| ---------------- | ------------------- | ------ |
| Vitacost         | iHerbより安いことも | ⭐⭐⭐ |
| Swanson Vitamins | 自社ブランドが安い  | ⭐⭐⭐ |
| Life Extension   | 高品質路線          | ⭐⭐   |
| Puritan's Pride  | セール時激安        | ⭐⭐   |

**注意**: CJ内で日本語対応サプリサイトはiHerbのみ
