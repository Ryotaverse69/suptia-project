...
async function createNDJSON() {
  ...
  const products = [
    // DHC製品
    {
      ...
      slug: { _type: "slug", current: "dhc-vitamin-c-30days" },
      brand: { _type: "reference", _ref: brandMap["DHC"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["vitamin-c"] }],
      priceJPY: 380,
      servingSize: "2粒",
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "dhc-multivitamin-30days" },
      brand: { _type: "reference", _ref: brandMap["DHC"] },
      ingredients: [
        { _type: "reference", _ref: ingredientMap["vitamin-c"] },
        { _type: "reference", _ref: ingredientMap["vitamin-d"] },
        { _type: "reference", _ref: ingredientMap["vitamin-b-complex"] },
      ].filter((i) => i._ref),
      priceJPY: 458,
      servingSize: "1粒",
      servingsPerContainer: 30,
    ...
    },
    {
      _type: "product",
      name: "DHC EPA 30日分",
      slug: { _type: "slug", current: "dhc-epa-30days" },
      brand: { _type: "reference", _ref: brandMap["DHC"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["omega-3"] }].filter(
        (i) => i._ref
      ),
      priceJPY: 918,
      servingSize: "3粒",
    ...
    },
    {
      _type: "product",
      name: "DHC 亜鉛 30日分",
      slug: { _type: "slug", current: "dhc-zinc-30days" },
      brand: { _type: "reference", _ref: brandMap["DHC"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["zinc"] }].filter(
        (i) => i._ref
      ),
      priceJPY: 287,
      servingSize: "1粒",
    ...
    // 大塚製薬製品
    {
      ...
      slug: { _type: "slug", current: "naturemade-super-multi-120" },
      brand: { _type: "reference", _ref: brandMap["大塚製薬"] },
      ingredients: [
        { _type: "reference", _ref: ingredientMap["vitamin-c"] },
        { _type: "reference", _ref: ingredientMap["vitamin-d"] },
        { _type: "reference", _ref: ingredientMap["vitamin-b-complex"] },
        { _type: "reference", _ref: ingredientMap["calcium"] },
        { _type: "reference", _ref: ingredientMap["magnesium-glycinate"] },
        { _type: "reference", _ref: ingredientMap["zinc"] },
        { _type: "reference", _ref: ingredientMap["iron"] },
      ].filter((i) => i._ref),
      priceJPY: 1980,
      servingSize: "1粒",
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "naturemade-vitamin-d-1000iu" },
      brand: { _type: "reference", _ref: brandMap["大塚製薬"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["vitamin-d"] }].filter(
        (i) => i._ref
      ),
      priceJPY: 798,
      servingSize: "1粒",
    ...
    // NOW Foods製品
    {
      ...
      slug: { _type: "slug", current: "now-vitamin-d3-5000iu" },
      brand: { _type: "reference", _ref: brandMap["NOW Foods"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["vitamin-d"] }].filter(
        (i) => i._ref
      ),
      priceJPY: 1680,
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "now-omega3-1000mg" },
      brand: { _type: "reference", _ref: brandMap["NOW Foods"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["omega-3"] }].filter(
        (i) => i._ref
      ),
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "now-zinc-50mg" },
      brand: { _type: "reference", _ref: brandMap["NOW Foods"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["zinc"] }].filter(
        (i) => i._ref
      ),
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "now-magnesium-400mg" },
      brand: { _type: "reference", _ref: brandMap["NOW Foods"] },
      ingredients: [
        { _type: "reference", _ref: ingredientMap["magnesium-glycinate"] },
      ].filter((i) => i._ref),
    ...
    // Thorne製品
    {
      ...
      slug: { _type: "slug", current: "thorne-multi-elite-am-pm" },
      brand: { _type: "reference", _ref: brandMap["Thorne"] },
      ingredients: [
        { _type: "reference", _ref: ingredientMap["vitamin-c"] },
        { _type: "reference", _ref: ingredientMap["vitamin-d"] },
        { _type: "reference", _ref: ingredientMap["vitamin-b-complex"] },
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "thorne-vitamin-d3-5000iu" },
      brand: { _type: "reference", _ref: brandMap["Thorne"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["vitamin-d"] }].filter(
        (i) => i._ref
      ),
    ...
    // Life Extension製品
    {
      ...
      slug: { _type: "slug", current: "life-extension-two-per-day-120" },
      brand: { _type: "reference", _ref: brandMap["Life Extension"] },
      ingredients: [
        { _type: "reference", _ref: ingredientMap["vitamin-c"] },
        { _type: "reference", _ref: ingredientMap["vitamin-d"] },
        { _type: "reference", _ref: ingredientMap["vitamin-b-complex"] },
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "life-extension-super-omega3" },
      brand: { _type: "reference", _ref: brandMap["Life Extension"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["omega-3"] }].filter(
        (i) => i._ref
      ),
    ...
    },
    {
      ...
      slug: { _type: "slug", current: "life-extension-vitamin-c-1000mg" },
      brand: { _type: "reference", _ref: brandMap["Life Extension"] },
      ingredients: [{ _type: "reference", _ref: ingredientMap["vitamin-c"] }].filter(
        (i) => i._ref
      ),
      priceJPY: 2180,
      servingSize: "1粒",
  ...
  writeFileSync("real-products-import.ndjson", ndjson);
  console.log(
    `\n✅ ${products.length}件の商品データをreal-products-import.ndjsonに出力しました`
  );
}
...
createNDJSON()
  .then(() => {
    console.log("\n次のコマンドでインポートできます:");
    console.log(
      "npx sanity dataset import real-products-import.ndjson production"
    );
    process.exit(0);
  })
  .catch((error) => {
