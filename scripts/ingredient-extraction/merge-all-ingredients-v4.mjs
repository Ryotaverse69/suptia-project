...
console.log('\n📝 全成分データを既存データとマージ中（v4）...\n');

// NDJSONファイルを読み込む
const ndjsonContent = fs.readFileSync('extracted-all-ingredients-v4.ndjson', 'utf-8');
...
fs.writeFileSync('merged-products-with-ingredients-v4.ndjson', ndjson);

console.log(`✅ merged-products-with-ingredients-v4.ndjson を作成しました（${mergedProducts.length}件）\n`);
console.log('次のステップ:');
console.log('  npx sanity dataset import merged-products-with-ingredients-v4.ndjson production --replace\n');
