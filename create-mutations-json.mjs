...
// Write JSON with mutations array
const payload = { mutations };
writeFileSync('update-all-ingredients.json', JSON.stringify(payload, null, 2));

console.log(`\n✓ Created update-all-ingredients.json with ${mutations.length} mutations`);
console.log('\nTo import, run:');
...
console.log('  -d @update-all-ingredients.json');
