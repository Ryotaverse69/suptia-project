...
**成果**: データカバレッジ 76.2% → 80.4% (+4.2%, +14商品)
...
| **短期合計** | -      | -                     | **19h** | **+15-26%**            | ✅ 完了    |
| 3-4週目      | 中     | 5. AI安全性強化       | 3h      | -                      | ⏳ 計画中  |
| 4週目        | 中     | 6. スコアリング       | 5h      | -                      | ⏳ 計画中  |
| 4週目        | 中     | 7. フォールバック統一 | 4h      | -                      | ⏳ 計画中  |
| **中期合計** | -      | -                     | **12h** | **メンテナンス性向上** | ⏳ 計画中  |

**実績データカバー率**: 76.2% → **80.4% (+4.2%)** ✅
**次期目標**: 80.4% → **95-100%**（中期項目5-7 + AI活用）
...
**項目6: 成分名スコアリング機能** - 誤抽出の削減

- 部分一致スコアリングで「ビタミンC誘導体」vs「ビタミンC」を区別
- 工数: 4-5時間
- 期待効果: 誤抽出 -5-10件

#### 短期実装（2-4週間）

**項目7: フォールバック階層の統一** - メンテナンス性向上

- 商品名 → allIngredients → AI → 手動入力の明確化
- 工数: 3-4時間
- 期待効果: コード可読性・保守性向上
