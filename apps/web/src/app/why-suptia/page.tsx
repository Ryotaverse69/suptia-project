...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "サプティアのすべての情報は、PubMed、Cochrane Library、厚生労働省などの信頼できる一次ソースに基づいています。また、すべてのコンテンツは薬機法に準拠しており、エビデンスレベル（S+〜D）で科学的根拠の強さを明示しています。",
  },
  {
    question: "無料で使えますか？",
    answer:
      "はい、基本機能は完全無料です。商品検索、価格比較、成分ガイド、診断機能、マイページ、価格アラートなどをお使いいただけます。2026年1月より、AIコンシェルジュを提供するProプラン（月額490円）と、既往歴・服薬・アレルギーに基づく安全性チェック機能を備えたPro+Safetyプラン（月額980円）を予定しています。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "マイページでは、プロフィール設定、診断履歴の確認、お気に入り商品の管理、価格アラートの設定ができます。また、健康目標やアレルギー情報を登録することで、より適切な商品推薦を受けられます。",
  },
];
