...
const faqData = [
  {
    question: "サプティア（Suptia）とは何ですか？",
    answer:
      "サプティアは科学的エビデンスに基づいてサプリメントを比較・評価できる無料サービスです。価格、成分量、コストパフォーマンス、エビデンスレベル、安全性の5つの軸で商品を評価し、あなたに最適なサプリメント選びをサポートします。",
  },
  {
  ...
  {
    question: "サプティアは無料で利用できますか？",
    answer:
      "はい、サプティアのすべての機能は完全無料でご利用いただけます。商品の検索、比較、成分ガイドの閲覧、診断機能など、すべて無料です。アフィリエイトリンク経由で購入いただくことで、サービスの運営を支援していただけます。",
  },
];
