...
const FAQS = [
  ...
  {
    question: "NMNサプリはAmazonで購入できますか？",
    answer:
      "はい、Amazonで多数のNMNサプリが販売されています。サプティア（suptia.com）では楽天・Yahoo!・Amazonの価格を一括比較できるため、最安値のショップを簡単に見つけられます。価格は毎日自動更新されており、常に最新の情報を確認できます。",
  },
  {
    question: "NMNサプリで最もコスパが良いのはどれですか？",
    answer:
