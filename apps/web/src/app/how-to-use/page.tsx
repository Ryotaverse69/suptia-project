...
const faqData = [
  {
    ...
    answer:
      "基本機能は無料でご利用いただけます。Freeプランでは週5回のAI質問、30日間の価格履歴閲覧が可能です。より多くの質問や高度な機能が必要な方にはPro（¥590/月）、Pro+Safety（¥1,280/月）プランをご用意しています。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "あなたの既往歴・服薬情報・アレルギーを考慮し、相互作用のある成分を自動でチェック。危険な成分を含む商品は自動ブロックされ、複雑なケースでは最高性能のAIモデル（Opus 4.5）が対応します。PMDA・Natural Medicines Database等の信頼性の高いソースに基づいています。",
  },
  {
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-3">
              {[
                {
                  q: "利用料金はかかりますか？",
                  a: "基本機能は無料でご利用いただけます。Freeプランでは週5回のAI質問、30日間の価格履歴閲覧が可能です。より多くの質問や高度な機能が必要な方にはPro（¥590/月）、Pro+Safety（¥1,280/月）プランをご用意しています。",
                },
                {
                ...
                },
                {
                  ...
                  a: "あなたの既往歴・服薬情報・アレルギーを考慮し、相互作用のある成分を自動でチェック。危険な成分を含む商品は自動ブロックされ、複雑なケースでは最高性能のAIモデル（Opus 4.5）が対応します。",
                },
                {
