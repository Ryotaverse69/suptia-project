              ...
              <div className="relative p-4 sm:p-5">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                      <motion.p
                        ...
                        animate={{ color: isHovered ? "#3b66e0" : "#1e293b" }}
                        transition={{ duration: 0.3 }}
                      >
                        {text}
                      </motion.p>
                  ...
                  <div className="flex items-center gap-2">
                    <Link href={href}>
                      <motion.button
                        className="group relative px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl overflow-hidden will-change-transform"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        style={{ transform: "translateZ(0)" }}
                      >
                        {/* Button Background - 強化版 */}
                        <motion.div
                    ...
                    {/* Dismiss Button - 強化版 */}
                    <motion.button
                      className="p-2 rounded-lg hover:bg-slate-100 transition-colors will-change-transform"
